...
public final class Constants {
  ...
  public static final class DriveConstants {
    ...
    public static final double kRegularSpeed = 0.7; // Regular speed multiplier of robot

    public static final double kSprintSpeed = 1; // Slow speed multiplier of robot
